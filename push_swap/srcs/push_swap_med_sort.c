...
/*   Updated: 2019/01/25 18:52:00 by pmasson          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	push_swap_med_sort_ahigh(t_ps *all)
{
	...
	if (all->elema1 == 3)
	{
		if (tmpa->next->next->place > tmpa->next->place && tmpa->next->next->place > tmpa->place)
		{
			all->elema0++;
			all->elema1--;
		}
...
void	push_swap_med_sort_alow(t_ps *all, int i)
{
	...
	if (all->elema1 == 2)
	{
		if (tmpa->place > tmpa->next->place && all->numb[i] > 1 && tmpb->place < tmpb->next->place)
