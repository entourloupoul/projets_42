...
/*   Updated: 2019/01/30 08:48:48 by pmasson          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_checker_check_result_visual(t_stack **a, t_stack **b,\
		t_ps_window *window)
{
	t_stack *tmp;
...
int		push_swap_visual_command_error(t_ps_window *window)
{
	write(2, "Error\n", 6);
...
int		push_swap_visual_command(t_ps_window *window)
{
	...
	if (window->play == 1)
	{
		...
		if (tr < 0)
			return (push_swap_visual_command_error(window));
		if (tr == 0)
