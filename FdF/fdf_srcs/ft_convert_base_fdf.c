...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_convert_base_fdf.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: pmasson <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/29 16:44:20 by pmasson           #+#    #+#             */
/*   Updated: 2018/11/30 18:11:55 by pmasson          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char					*ft_convert_base_fdf(const char *base1,\
		const char *base11, const char *base2, char *str)
{
	char			*ret;
	unsigned long	l;
	...
	if (ft_valid_base(base2) == 0)
		return (NULL);
	if (ft_valid_input(base1, str) == 1)
	{
		l = ft_basetol(base1, str);
		ret = ft_ltobase(base2, l);
		return (ret);
	}
	if (ft_valid_input(base11, str) == 1)
	{
		l = ft_basetol(base11, str);
		ret = ft_ltobase(base2, l);
		return (ret);
	}
	return ("16777215");
